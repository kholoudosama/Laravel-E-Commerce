...
@section('content')         
                    ...
                    <div class="col-lg-12">
                      <div class="card">
                          <div class="card-body">
                             <h3 class="card-title">Edite Pruduct</h3>
                             ...
                             {!!Form::open(['action' => 'ProductController@updateproduct' ,
                           ...
                           <div class="form-group">
                             ...
                             {{Form::text( 'product_name' , $Products->product_name,['class' => 'form-control' ,'minlength' => '2' ])}}
                           </div>
                             <div class="form-group">
                             ...
                             {{Form::select( 'product_category' ,$categories,$Products->product_category ,
